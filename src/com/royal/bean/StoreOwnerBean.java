...
public class StoreOwnerBean 
{
	...
	public StoreOwnerBean(int store_ownerID, String store_ownerName, String store_ownerContact, String store_ownerEmail, String store_ownerPassword) 
	{
		super();
	...
	public StoreOwnerBean(int store_ownerID, String store_ownerName, String store_ownerContact, String store_ownerEmail) 
	{
		super();
		this.store_ownerID=store_ownerID;
		this.store_ownerName=store_ownerName;
	...
	public StoreOwnerBean(String store_ownerName, String store_ownerContact, String store_ownerEmail,String store_ownerPassword) 
	{
		super();
		this.store_ownerName=store_ownerName;
		this.store_ownerContact=store_ownerContact;
