<!DOCTYPE html>
<%@page import="com.royal.bean.FeedbackBean"%>
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <%
				ArrayList<FeedbackBean> getAllFeedbacks = (ArrayList<FeedbackBean>)request.getAttribute("getAllFeedbacks");
			%>
				<table border="1">
					<tr>
				...
				<%
							for(int i=0;i<getAllFeedbacks.size();i++)
							{
								FeedbackBean feedbackBean = getAllFeedbacks.get(i);
				%>
							<tr>
								<td><%=feedbackBean.getFeedback_message()%></td>
								<td><%=feedbackBean.getEmail()%></td>
								<td><%=feedbackBean.getFirst_Name()%></td>
								<td><%=feedbackBean.getLast_Name()%></td>
							</tr>	
				<%
				}
				%>
