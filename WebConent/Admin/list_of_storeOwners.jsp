...
<div class="ch-container">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <a href="list_of_storeOwners.jsp">StoreOwners</a>
        </li>
    </ul>
</div>
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <%
				ArrayList<StoreOwnerBean> getAllStoreOwners = (ArrayList<StoreOwnerBean>)request.getAttribute("getAllStoreOwners");
			%>
				<table border="1">
					<tr>
						<th>StoreOwnerId</th>
						<th>StoreOwner_Name</th>
						<th>StoreOwner_Contact</th>
						<th>StoreOwner_Email</th>
						<th>Actions</th>
					</tr>
				<%
							for(int i=0;i<getAllStoreOwners.size();i++)
							{
								StoreOwnerBean storeownerBean = getAllStoreOwners.get(i);
				%>
							<tr>
								<td><%=storeownerBean.getStore_ownerID()%></td>
								<td><%=storeownerBean.getStore_ownerName()%></td>
								<td><%=storeownerBean.getStore_ownerContact()%></td>
								<td><%=storeownerBean.getStore_ownerEmail()%></td>
								<td><a href='DeleteStoreOwnerServlet?store_ownerID=<%=storeownerBean.getStore_ownerID()%>' class="btn btn-danger"><i class="glyphicon glyphicon-trash icon-white"></i>Delete</a> <a href='StoreListServlet?store_ownerEmail=<%=storeownerBean.getStore_ownerEmail()%>' class="btn btn-success"><i class="glyphicon glyphicon-check"></i>Check Stores</a> </td>
							</tr>	
				<%
				}
				%>
