        ...
        <%
			...
			%>
				...
				<%
							...
							{
								ProductBean productBean = listofProducts.get(i);
				%>
							<tr>
								<td><%=productBean.getProduct_Name()%></td>
								<td><%=productBean.getProduct_Price()%></td>								
								<td><img src="http://localhost:8080/designing/<%=productBean.getImg1()%>" height="50px" width="50px"></td>								
								<td><%=productBean.getNo_of_product()%></td>							
