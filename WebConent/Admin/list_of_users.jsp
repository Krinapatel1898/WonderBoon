        ...
        <div class="navbar-inner">
            ...
            <div class="btn-group pull-right">
                <button class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                    <i class="glyphicon glyphicon-user"></i><span class="hidden-sm hidden-xs"> <%=session.getAttribute("fullname") %></span>
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <%
				ArrayList<UserBean> listofusers = (ArrayList<UserBean>)request.getAttribute("listofusers");
			%>
				<table border="1">
					<tr>
						<th>Full Name</th>
				...
				<%
							...
							{
								UserBean userBean = listofusers.get(i);
				%>
							<tr>
								<td><%=userBean.getFullname()%></td>
								<td><%=userBean.getEmail()%></td>
								<td><%=userBean.getContact_no()%></td>
								<td>
								<a href='AdminViewUserOrderListServlet?email=<%=userBean.getEmail()%>' class="btn btn-primary"><i class="glyphicon glyphicon-eye-open"></i> View Order History</a>								
								</td>
							</tr>	
				<%
				}
