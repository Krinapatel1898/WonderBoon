...
<div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon list"></i>Order List</h2>
    ...
    <div class="box-content">
            <%
				ArrayList<OrderBean> getAllOrders = (ArrayList<OrderBean>)request.getAttribute("getAllOrders");
			%>
				...
				<%
							...
							{
								OrderBean orderBean = getAllOrders.get(i);
				%>
							<tr>
								<td><%=orderBean.getProduct_Name() %></td>
								<td><%=orderBean.getProduct_Price() %></td>
								<td><%=orderBean.getProduct_quantity() %></td>
								<td><%=orderBean.getDelivery_date() %></td>
								<td><%=orderBean.getDelivery_time() %></td>
								
								<td>
								<a href='AdminViewOrderServlet?orderID=<%=orderBean.getOrderID()%>' class="btn btn-primary"><i class="glyphicon glyphicon-eye-open"> </i> View Order</a>
								</td>
							</tr>	
				<%
				}
