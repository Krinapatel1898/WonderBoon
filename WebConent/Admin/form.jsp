...
<%
		...
		String admin_Email = "", admin_password = "", rememberVal = "";
		if (cookies != null) {
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content">
                <form role="form" action="UpdateAdminServlet">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Email address</label>
                        <input type="email" class="form-control" id="exampleInputEmail1" readonly="readonly" name="admin_Email" value="<%=session.getAttribute("admin_Email")%>">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Password</label>
                        <input type="password"  class="form-control" id="id2" name="admin_password" value="<%=session.getAttribute("admin_password")%>">
                    </div>
					...
					<div class="input-group input-group-lg">
						<input type="checkbox" hidden="" name="remember" value="1"
